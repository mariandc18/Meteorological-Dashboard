...
def register_callbacks(app):
    ...
    def update_cyclone_dropdown(season_range):
    ...
    def plot_single_cyclone(name, season_range):
    ...
    def cyclone_details_plot(name, season_range):
        session = get_db_session()
    ...
    def compare_cyclones(season_range):
        start_year, end_year = season_range
        session = get_db_session()
        df = pd.read_sql(
            session.query(CycloneTrajectory)
